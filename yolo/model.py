...
def get_layers(config: Config):
    ...
    for i, layer in enumerate(layers):
        ...
        if layer_type == "conv":
            in_channels = DEFAULT_IN_CHANNELS if prev_layer == None else prev_layer.out_channels
            ...
            in_features = DEFAULT_IN_CHANNELS if prev_layer == None else prev_layer.out_channels
